...
;;(define-key tex-mode-map (kbd "C-c C-e") 'TeX-command-run-all)
;;(define-key tex-mode-map (kbd "C-c C-c") 'reftex-citation)
;;(define-key tex-mode-map (kbd "C-c C-l") 'reftex-label)
